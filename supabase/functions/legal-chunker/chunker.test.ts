...
// Simulates Criminal Code excerpt:
// "\u0540\u0578\u0564\u057e\u0561\u056e 1\u0589 General provisions..."
// "\u0540\u0578\u0564\u057e\u0561\u056e 2\u0589 Criminal legislation..."
// "\u0540\u0578\u0564\u057e\u0561\u056e 3\u0589 Principle of legality..."
...
// Simulates cassation decision with:
// header, \u0563\u0578\u0580\u056e\u056b \u0570\u0561\u0576\u0563\u0561\u0574\u0561\u0576\u0584 (facts),
...
Deno.test("chunkDocument: legislation splits by articles", () => {
  ...
  // Should have article chunks (preamble may be skipped if too short)
  ...
  // Check locators exist on article chunks
...
Deno.test("chunkDocument: empty content returns empty array", () => {
  const chunks = chunkDocument({
    doc_type: "code",
    content_text: "",
  });
...
Deno.test("chunkDocument: deterministic output", () => {
  ...
  assertEquals(chunks1.length, chunks2.length);
  for (let i = 0; i < chunks1.length; i++) {
    assertEquals(chunks1[i].chunk_hash, chunks2[i].chunk_hash);
    assertEquals(chunks1[i].char_start, chunks2[i].char_start);
    assertEquals(chunks1[i].char_end, chunks2[i].char_end);
  }
});
