...
// Use production sitekey from environment variable, fallback to Cloudflare's test key
// Test key always passes - configure VITE_TURNSTILE_SITEKEY for real protection
